<?php include 'delete_function.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <p>
        ...
        ?>
                    ...
                    <div class="settings">....
                                ...
                                <li onclick="confirmRecovery(<?php echo $note['note_id']; ?>)">Recover Note</li>
                                   </ul>
                               </div><p>Created at: <?php echo $note['created_at']; ?></p>
                </div>
...
<div class="popup-box" id="add-note-popup">
    <div class="popup">
    <button onclick="closePopup('add-note-popup')" style="display: flex; margin-left: 495px; background-color: transparent; ">Close</button>
        <h2>Add Note</h2>
...
<div class="popup-box" id="view-note-popup-<?php echo $note['note_id']; ?>">
    <div class="popup">
    <button onclick="closePopup('view-note-popup-<?php echo $note['note_id']; ?>')" style="display: flex; margin-left: 495px; background-color: transparent; ">Close</button>
        <h2>View Note</h2>
        <div class="container1">
...
<div class="popup-box" id="edit-note-popup-<?php echo $note['note_id']; ?>">
    <div class="popup">
    <button onclick="closePopup('edit-note-popup-<?php echo $note['note_id']; ?>')" style="display: flex; margin-left: 495px; background-color: transparent; ">Close</button>
        <h2>Edit Note</h2>
        <div class="container1">
